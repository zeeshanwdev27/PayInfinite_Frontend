...
import HR_HeroSection from './HR_HeroSection'
import HighRiskIn from '../Home/HighRiskIn'
import PaymentSolutions from '../Home/PaymentSolutions'
import HR_MerchantProvider from './HR_MerchantProvider'
import HR_Faqs from './HR_Faqs'

...
import { HR_MerchantProviderCards } from "@/data/CardsData.js";
...
function HR_MerchantProvider() {
  ...
  const maxIndex = useMemo(() => {
    return Math.max(0, HR_MerchantProviderCards.length - visibleCount);
  }, [visibleCount]);
    ...
    <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-[6%] lg:px-[8%] text-white w-full">
      ...
      <div className="mt-10 sm:mt-14 lg:mt-20 max-w-7xl mx-auto">
        <div className="overflow-hidden">
          ...
          >
            {HR_MerchantProviderCards.map((item, i) => {
...
export default HR_MerchantProvider;
...
function LowRishIndus() {
  return (
    <section className="relative  py-24 px-4 sm:px-[8%] text-white">
      ...
      {/* Cards Grid */}
      <div className="mt-20 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
        {LowRiskCards.map((item, index) => {
          ...
          <div key={index} className={`relative rounded-3xl p-[1.5px]  bg-gradient-to-br from-amber-400 via-blue-400 to-cyan-400 ${staggerClass}`}>
            <div className="rounded-3xl p-6 flex flex-col gap-4 bg-[#0f172a] hover:scale-105 hover:bg-black hover:border hover:border-white transition-all duration-300 h-full">

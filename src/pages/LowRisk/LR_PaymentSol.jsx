...
function LR_PaymentSol() {
  const cards = [
    { image: "./LowRisk/img1.png", hover: "./LowRisk/img1.1.png" },
    { image: "./LowRisk/img2.png", hover: "./LowRisk/img2.2.png" },
    { image: "./LowRisk/img3.png", hover: "./LowRisk/img3.3.png" },
  ];

...
import { LW_LowRiskCards } from "@/data/CardsData.js";
import { motion } from "motion/react";



function LW_LowRiskIn() {
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-[6%] lg:px-[8%] text-white">
      ...
      <div className="max-w-5xl mx-auto text-center flex flex-col gap-4 sm:gap-5">
        ...
        <p className="text-white/70 text-sm sm:text-base">We work with trusted and compliant businesses across various low-risk industries, offering smooth onboarding and competitive processing solutions.</p>
      </div>
      ...
      <div className="mt-10 sm:mt-14 lg:mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8 lg:gap-10 max-w-7xl mx-auto">
        {LW_LowRiskCards.map((item, index) => {
